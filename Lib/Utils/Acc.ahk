   ...
   ;Https://, Msdn.Microsoft.Com/En-Us/Library/Windows/Desktop/Dd373600(V=Vs.85).Aspx
    ...
    class Viewer {
        __New() {
            ...
            this.TVAcc := this.gViewer.Add("TreeView", "x275 y25 w500 h390 -0x800")
        ...
        LVProps_Populate(oAcc) {
            ...
            if oAcc.HasMethod("Highlight")
                oAcc.Highlight(0) ; Indefinite show
            else
                return (ToolTip("{Acc.Viewer~LVProps_Populate} [FAILED]"), SetTimer((*)=>ToolTip()))
            this.LVProps.Delete()
        ...
        TVAcc_ContextMenu(GuiCtrlObj, Item, IsRightClick, X, Y) {
            ...
            TVAcc_Menu.Add('Default Action', (*)=>oAcc.DoDefaultAction())
            TVAcc_Menu.Show()
        }
